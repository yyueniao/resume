      ...
      <Stack direction="row" spacing={3} alignItems="center">
        ...
        <Stack>
          ...
          <Typography variant="body2">
            ...
            have expertise in a variety of technologies such as TypeScript, JavaScript, PHP Laravel,
            jQuery, React, NextJS, Java, bash, and Haskell. I am skilled in writing MySQL and
            PostgreSQL queries to manage databases and have experience in writing unit tests in Java
            and Haskell.
          </Typography>
          <Typography variant="body2">
